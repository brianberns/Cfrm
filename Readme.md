...
For multiple playerCounterfactual Regret Minimization (usually abbreviated as "CFR") is a technique for solving "imperfect-information" games.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzU4MzcwODAxXX0=
-->