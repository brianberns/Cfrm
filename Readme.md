...
You can think of `GameState`  as representing all the possible nodes in a game's move tree. `Key` is the node's unique ID and `LegalActions` are the branches leading to its child nodes
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc4NjU2NTI0MiwxOTkwNzMzMzI3LDEwND
A3MTg3MTNdfQ==
-->