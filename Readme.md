...
Counterfactual Regret Minimization (usually abbreviated as "CFR") is a technique for solving imperfect-information games. "Imperfect information" means player's keep some information private from each other. For example, in most card games, players keep their cards hidden from each other. Solving such a game means finding a Nash equilibrium, which is a strategy that
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5MjEwNTA1M119
-->